...
class ReportScreenTwo extends StatefulWidget {
  const ReportScreenTwo({super.key});

  @override
  State<ReportScreenTwo> createState() => _ReportScreenTwoState();
}
...
class _ReportScreenTwoState extends State<ReportScreenTwo> {
